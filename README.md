...
- [recipe: add gatekeeper as optional component](https://github.com/NVIDIA/aicr/pull/821) on [NVIDIA/aicr](https://github.com/NVIDIA/aicr) (3 days ago)
...
- [open-policy-agent/opa](https://github.com/open-policy-agent/opa) ([v1.16.1](https://github.com/open-policy-agent/opa/releases/tag/v1.16.1), 1 week ago) - Open Policy Agent (OPA) is an open source, general-purpose policy engine.
