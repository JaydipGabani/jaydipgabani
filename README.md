...
- [recipe: add gatekeeper as optional component](https://github.com/NVIDIA/aicr/pull/821) on [NVIDIA/aicr](https://github.com/NVIDIA/aicr) (5 days ago)
...
- [open-policy-agent/opa](https://github.com/open-policy-agent/opa) ([v1.16.2](https://github.com/open-policy-agent/opa/releases/tag/v1.16.2), 1 day ago) - Open Policy Agent (OPA) is an open source, general-purpose policy engine.
