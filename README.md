...
- [fix: register current admission webhook subresources](https://github.com/open-policy-agent/gatekeeper/pull/4785) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (5 days ago)
...
- [open-policy-agent/opa](https://github.com/open-policy-agent/opa) ([v1.20.1](https://github.com/open-policy-agent/opa/releases/tag/v1.20.1), 3 days ago) - Open Policy Agent (OPA) is an open source, general-purpose policy engine.
