...
- [ci: Check out release PR workflow before Go setup](https://github.com/open-policy-agent/gatekeeper/pull/4634) on [open-policy-agent/gatekeeper](https://github.com/open-policy-agent/gatekeeper) (6 days ago)
